...
###$2=inputFile
	...
	matrix=$2
	/bin/mkdir egg_cell1 cell1_cell4 cell4_cell64 cell64_k1 k1_sphere sphere_shield
	...
	awk ' $5!="NA" '  $matrix > cell64_k1/cell64_k1-var.txt
	awk ' $6!="NA" ' $matrix  > k1_sphere/k1_sphere-var.txt
	awk  ' $7!="NA" '  $matrix > sphere_shield/sphere_shield-var.txt
