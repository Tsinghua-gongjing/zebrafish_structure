...
function Calculation(){
	...
	cd $outPath
	mkdir "w"$1"_s"$2
	dir=$outPath/"w"$1"_s"$2
	
	
	input1=/pnas/yangyg_group/zhangting/SBY_structure-m5C-new2/0_combine/egg.icshape.w200.s30.T2.t200.out
	output='egg-smooth.out'
	bash $script $dir $output $window $step $input1 $positionFile

	input2=/pnas/yangyg_group/zhangting/SBY_structure-m5C-new2/0_combine/1cellnew.icshape.w200.s30.T2.t200.out
	output='cell1-smooth.out'
	bash $script $dir $output $window $step $input2 $positionFile

	input3=/pnas/yangyg_group/zhangting/SBY_structure-m5C-new2/0_combine/4cell.icshape.w200.s30.T2.t200.out
	output='cell4-smooth.out'
	bash $script $dir $output $window $step $input3 $positionFile

	input4=/pnas/yangyg_group/zhangting/SBY_structure-m5C-new2/0_combine/64cell.icshape.w200.s30.T2.t200.out
	output='cell64-smooth.out'
	bash $script $dir $output $window $step $input4 $positionFile


	input5=/pnas/yangyg_group/zhangting/SBY_structure-m5C-new2/0_combine/1K.icshape.w200.s30.T2.t200.out
	output='k1-smooth.out'
	bash $script $dir $output $window $step $input5 $positionFile

	input6=/pnas/yangyg_group/zhangting/SBY_structure-m5C-new2/0_combine/spherenew.icshape.w200.s30.T2.t200.out
	output='sphere-smooth.out'
	bash $script $dir $output $window $step $input6 $positionFile
	
	input7=/pnas/yangyg_group/zhangting/SBY_structure-m5C-new2/0_combine/shield.icshape.w200.s30.T2.t200.out
	output='shield-smooth.out'
	bash $script $dir $output $window $step $input7 $positionFile
	...
	matrixName="smooth-bigmatrix-stage7"

	###########$dirName
	cd $dir
	dir2=./
	input1=egg-smooth.out
	input2=cell1-smooth.out
	input3=cell4-smooth.out
	input4=cell64-smooth.out
	input5=k1-smooth.out
	input6=sphere-smooth.out
	input7=shield-smooth.out
	bash $script $dir2 $matrixName $input1  $input2 $input3 $input4 $input5 $input6 $input7
}
