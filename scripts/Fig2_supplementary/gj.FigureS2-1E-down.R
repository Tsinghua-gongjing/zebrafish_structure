...
# output="01_001-down"
x1 <- paste(path,"down/annotation/egg_cell1-anno.bed",sep='')
x2 <- paste(path,"down/annotation/cell1_cell4-anno.bed",sep='')
x3 <- paste(path,"down/annotation/cell4_cell64-anno.bed",sep='')
x4 <- paste(path,"down/annotation/cell64_sphere-anno.bed",sep='')
x5 <- paste(path,"down/annotation/sphere_shield-anno.bed",sep='')
