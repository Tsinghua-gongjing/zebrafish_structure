...
def structure_diff_vs_TE_diff(structure=None, TE=None, label1='control', label2='RK33', feature='UTR5'):
	if structure is None:
		structure = '/Share/home/zhangqf7/gongjing/zebrafish/result/riboseq_rnaseq/xtail/total.RPKM_combine.merge.addTwoRP33.t200.gini.null40.txt'
	if TE is None:
	...
	a[2].set_title('n=%s'%(n))
	plt.tight_layout()
	plt.savefig('/Share/home/zhangqf7/gongjing/zebrafish/result/riboseq_rnaseq/xtail/structure_diff_vs_TE_diff.GiniDivideTEminus.pdf')
	plt.close()
...
structure_diff_vs_TE_diff(TE='/Share/home/zhangqf7/gongjing/zebrafish/result/riboseq_rnaseq/20190415_TE_corr.txt', feature='transcript')
