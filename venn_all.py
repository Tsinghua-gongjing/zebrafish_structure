...
### downloaded from: https://github.com/tctianchi/pyvenn, 2~6 sets venn diagram for python
...
#default_colors = sns.color_palette("deep", n_colors=6) # sns deep color, overlapped part is not transcparent
