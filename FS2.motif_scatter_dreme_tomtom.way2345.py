...
def plot_motif_logo(motif_ls, site_num_ls, pvalue_ls, tomtom_file, rbp_name):
    ...
    plt.tight_layout()
    savefn = '/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/results/FS2.motif_scatter_dreme_tomtom.pdf'
    plt.savefig(savefn)
    
rbp_name = read_RBP_name()
print rbp_name

motif_df = read_dmeme('/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/dynamic_region/way2345/dreme.txt')
...
tomtom_file = '/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/dynamic_region/way2345/tomtom.tsv'
