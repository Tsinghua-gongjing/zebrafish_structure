...
print(path)
print(output)
path='/Share/home/zhangqf7/gongjing/zebrafish/result/dynamic_merge_region/005_005_new/'
output="005_005-abs"
setwd("/Share2/home/zhangqf7/gongjing/zebrafish/result/zhangting_provided/Figure-structure-main/dynamic_enrich")
#############up 
x1 <- paste(path,"abs/egg_cell1/window-anno.bed",sep='')
x2 <- paste(path,"abs/cell1_cell4/window-anno.bed",sep='')
x3 <- paste(path,"abs/cell4_cell64/window-anno.bed",sep='')
x4 <- paste(path,"abs/cell64_sphere/window-anno.bed",sep='')
x5 <- paste(path,"abs/sphere_shield/window-anno.bed",sep='')

#############dwon
y1 <- paste(path,"abs/egg_cell1/window-anno.bed",sep='')
y2 <- paste(path,"abs/cell1_cell4/window-anno.bed",sep='')
y3 <- paste(path,"abs/cell4_cell64/window-anno.bed",sep='')
y4 <- paste(path,"abs/cell64_sphere/window-anno.bed",sep='')
y5 <- paste(path,"abs/sphere_shield/window-anno.bed",sep='')
...
########################算富集的分
utr3 <- read.table("/Share2/home/zhangqf7/gongjing/zebrafish/data/reference/transcriptome/UTR3.txt",sep="\t", stringsAsFactors=F)
transcript <- read.table("/Share2/home/zhangqf7/gongjing/zebrafish/script/zhangting/supplementary/wholeTransPositionDetail.txt",sep="\t", stringsAsFactors=F)
