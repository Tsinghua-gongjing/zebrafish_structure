...
pdf(plot_filepath, width = 10, height = 8, onefile=FALSE)
upset(fromExpression(upset_expression),
	  sets=c('sphere_shield/sphere_shield-var.sorted.merge.bed', 'cell64_sphere/cell64_sphere-var.sorted.merge.bed', 'cell4_cell64/cell4_cell64-var.sorted.merge.bed', 'cell1_cell4/cell1_cell4-var.sorted.merge.bed', 'egg_cell1/egg_cell1-var.sorted.merge.bed'),
