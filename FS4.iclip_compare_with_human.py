...
def read_human_hur():
	fn1 = '/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/iCLIP/human_HuR/1-s2.0-S1097276511004229-mmc3.xls'
	df1 = pd.read_excel(fn1, sheet_name='consensus')
	gene_ls1 = df1['Gene']
	print "table1: %s"%(len(gene_ls1))

	fn2 = '/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/iCLIP/human_HuR/molcel_3918_mmc3.csv'
...
trans_dict = loadTransGtfBed2('/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/ref/danRer10.refSeq.transcriptome.trans.bed2')
ortholog_dict = read_ortholog('/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/ref/transcript_human_ortholog.txt')

human1, human2 = read_human_hur()
h4 = read_bed('/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/iCLIP/h4/h4_all_rep12.c6.utr3.bed', trans_dict, ortholog_dict)
h6 = read_bed('/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/data/iCLIP/h6/h6_all_rep12.c6.utr3.bed', trans_dict, ortholog_dict)
...
plt.tight_layout()
savefn = '/Share2/home/zhangqf7/gongjing/zebrafish/script/zebrafish_structure/results/FS4.h4_h6_rep12.c6.humanHuR.overlap.pdf'
plt.savefig(savefn)
plt.close()
